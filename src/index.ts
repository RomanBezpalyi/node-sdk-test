...
import { config } from '@ciklum-toggler/node-sdk';
...
config.init({
	toggleUrl:
		'http://svc.feature-toggle.pp.ciklum.com/api/external-systems-access',
  envKey: 'a78a7d7cf0cff5488a06e247f347fd3909ed1c7c69a2d707',
  cachePeriod: 1000,
});
